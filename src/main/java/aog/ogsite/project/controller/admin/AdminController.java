package aog.ogsite.project.controller.admin;


import aog.ogsite.project.domain.*;
import aog.ogsite.project.dto.*;
import aog.ogsite.project.service.ItemServiceImpl;
import aog.ogsite.project.service.MemberServiceImpl;
import aog.ogsite.project.service.OrderServiceImpl;
...
public class AdminController {
    ...
    public String requestupload2(MultipartHttpServletRequest mtfRequest, @RequestParam("cmode1") String firstCategory
        ...
        String folderPath = "D:\\ogsite\\src\\main\\resources\\static\\image\\Item\\" + firstCategory + "\\" + secondCategory + "\\" + itemName + "\\";
