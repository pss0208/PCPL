...
//        위에거 1차 카테고리 : TOP 2차 카테고리 : longsleeve 위와 중복 url 아님
        ...
        webCrawlingMethod("https://page27.co.kr/product/%EB%85%B8%EB%A9%80-%EC%9B%8C%EC%8B%B1-%EC%BD%94%ED%8A%BC%EC%9E%90%EC%BC%935color/3229/category/45/display/1/", 98L);
...
//                        FileOutputStream repOut = new FileOutputStream("D:\\ogsite\\src\\main\\resources\\static\\image\\Item\\OUTER\\jacket\\" + itemName + "\\" + itemName + "0" + ".jpg");
                        FileOutputStream repOut = new FileOutputStream("D:\\ogsite\\src\\main\\resources\\static\\image\\Item\\OUTER\\jacket\\" + itemName + "\\" + itemName + i + ".jpg");
